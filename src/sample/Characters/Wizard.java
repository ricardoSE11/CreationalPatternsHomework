...
public class Wizard extends Character{
    ...
    public Wizard(Weapon weapon, int level)
    {
    ...
    public void setUpSprites(int level){
        ...
        switch (level) {
            case 1:{
                try {
                    for (int i = 0 ; i < 10 ; i++){
                        sprites.add(new Image(new FileInputStream("src/Assets/Wizard/LevelOne/" + i + ".png")));
                    }
                    //System.out.println("Succesfully loaded Archer sprites");
                }
            ...
            case 2:{
                try {
                    for (int i = 0 ; i < 10 ; i++){
                        sprites.add(new Image(new FileInputStream("src/Assets/Wizard/LevelTwo/" + i + ".png")));
                    }
            ...
            case 3:{
                try {
                    for (int i = 0 ; i < 10 ; i++){
                        sprites.add(new Image(new FileInputStream("src/Assets/Wizard/LevelThree/" + i + ".png")));
                    }
                }
                catch (FileNotFoundException e) {
                    e.printStackTrace();
    ...
    public ICharacterPrototype deepClone() {
        ...
        ICharacterPrototype newWizard = new Wizard(weapon , this.level);
        return newWizard;
    }
