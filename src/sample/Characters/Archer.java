...
public class Archer extends Character{
    ...
    public Archer(Weapon weapon, int level)
    {
    ...
    public void setUpSprites(int level){
        ...
        switch (level) {
            case 1:{
                try {
                    for (int i = 0 ; i < 10 ; i++){
                        sprites.add(new Image(new FileInputStream("src/Assets/Archer/LevelOne/" + i + ".png")));
                    }
                }
            ...
            case 2:{
                try {
                    for (int i = 0 ; i < 10 ; i++){
                        sprites.add(new Image(new FileInputStream("src/Assets/Archer/LevelTwo/" + i + ".png")));
                    }
                }
                catch (FileNotFoundException e) {
                    e.printStackTrace();
            ...
            case 3:{
                try {
                    for (int i = 0 ; i < 10 ; i++){
                        sprites.add(new Image(new FileInputStream("src/Assets/Archer/LevelThree/" + i + ".png")));
                    }
                }
                catch (FileNotFoundException e) {
                    e.printStackTrace();
    ...
    public ICharacterPrototype deepClone() {
        ...
        ICharacterPrototype newArcher = new Archer(weapon , this.level);
        return newArcher;
    }
